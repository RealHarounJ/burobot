...
const plans = [
  {
    ...
    price: "€0",
    period: "/mese",
    desc: "Ideale per iniziare",
    features: [
      "Analisi dei documenti illimitata",
      "Spiegazione in linguaggio semplice",
      "Analisi scadenze e importi PagoPA/F24",
      "AI Copilot Chat base sui documenti",
      "Storico delle analisi salvato",
    ],
    btnText: "Usa Gratis",
    featured: false,
  },
  {
    ...
    price: "€4.99",
    period: "/mese",
    desc: "Per sbloccare tutte le funzioni",
    features: [
      "Tutto del piano Free (Analisi e Chat illimitate)",
      "Generazione lettere di risposta / ricorsi legali",
      "Esportazione PDF professionale avanzata",
      "Importazione leggi da Normattiva",
      "Analisi contratti commerciali",
      "Funzionalità gestione collaboratori e team",
      "Supporto prioritario via WhatsApp ed Email",
    ],
    btnText: "Attiva Pro",
    featured: true,
  },
